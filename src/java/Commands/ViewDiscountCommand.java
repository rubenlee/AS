...
@WebServlet(name = "ViewDiscountCommand", urlPatterns = {"/ViewDiscountCommand"})
public class ViewDiscountCommand extends FrontCommand {
    ...
    public void process() {
        ...
        if(request.getParameter("new") != null){
            discountFacade.insertNew(request.getParameter("new"),Integer.parseInt(request.getParameter("value")));
        }
